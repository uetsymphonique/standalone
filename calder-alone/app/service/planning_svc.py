...
class PlanningService(BasePlanningService):
    ...
    async def get_links(self, operation: Operation, buckets=None, agent=None, trim=True):
    ...
    async def generate_and_trim_links(self, agent, operation: Operation, abilities, trim=True):
